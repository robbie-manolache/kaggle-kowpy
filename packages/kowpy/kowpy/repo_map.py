...
def map_directory(directory: str, prefix: str = "", is_last: bool = True, parent_prefix: str = "") -> str:
    """
    Maps out the structure of a directory and returns it as a formatted string in tree format.
    ...
    Returns:
        str: A formatted string representing the directory structure in tree format
    """
    result = []
    try:
        path = Path(directory)
